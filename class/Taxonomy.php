...
/* 
	...
	$sys=new DB();
		...
		<span style="font-size:"'.$tagsize.'pt;">'.$tagname.'</span> ('.$numtags.')</a> ';
		}
	} */
...
/* 	public function get_category_drop_list($query){
		...
		//echo '<OPTION SELECTED value="index.php">'.$tagname.'('.$numtags.')</option>'; 	
		echo '<option value="'.ROOT.'cat&cid='.$id.'">'.$tagname.'('.$numtags.')</option>';	
		}
		echo '</select></form>';
	} */
