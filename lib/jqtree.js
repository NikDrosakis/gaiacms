...
! function(e) {
    ...
    var n = function() {
        ...
        return e.register = function(t, o) {
            ...
            this._deinit()
        }, e.prototype._init = function() {}, e.prototype._deinit = function() {}, e.defaults = {}, e
    }();
    t.default = n
}, function(e, t, o) {
    "use strict";
    ...
    var s = o(5),
        ...
        S = function(e) {
                    ...
                    if (o)
                        if ("button" === o.type) t.toggle(o.node, t.options.slide), e.preventDefault(), e.stopPropagation();
                            ...
                            t._triggerEvent("tree.click", {
                                node: n,
                                click_event: e
                            }).isDefaultPrevented() || t._selectNode(n)
                        }
                }, t._handleDblclick = function(e) {
                    var o = t._getClickTarget(e.target);
                    o && "label" === o.type && t._triggerEvent("tree.dblclick", {
                        node: o.node,
                        click_event: e
                    })
                }, t._handleContextmenu = function(e) {
                    var o = a(e.target).closest("ul.jqtree-tree .jqtree-element");
                    if (o.length) {
                        var n = t._getNode(o);
            ...
            return r(t, e), t.prototype.toggle = function(e, t) {
                ...
                if (!e) throw Error(N);
                var o = null == t ? this.options.slide : t;
                return (e.isFolder() || e.isEmptyFolder) && (new _.FolderElement(e, this).close(o, this.options.animationSpeed), this._saveState()), this.element
                ...
                return o && this.tree.removeNodeFromIndex(e), e.setData(t), o && this.tree.addNodeToIndex(e), "object" == typeof t && t.children && (e.removeChildren(), t.children.length && e.loadFromData(t.children)), this._refreshElements(e), this._selectCurrentNode(), this.element
                ...
                if (!e) throw Error(N);
                var o = e;
                return this.selectNodeHandler && (this.selectNodeHandler.addToSelection(o), this._getNodeElementForNode(o).select(void 0 === t || t), this._saveState()), this.element
                ...
                if (!e) throw Error(N);
                return this.selectNodeHandler && (this.selectNodeHandler.removeFromSelection(e), this._getNodeElementForNode(e).deselect(), this._saveState()), this.element
                ...
                var t, o = this,
                    ...
                    r = function(t) {
                        if (e && e.id) {
                            ...
                            var r = o._getNodeIdToBeSelected();
                            if (r) {
                                n = {
                                    selected_node: r
                                };
                ...
                if (this.selectNodeHandler) {
                    ...
                    if (o.options.onCanSelectNode ? o.options.selectable && o.options.onCanSelectNode(e) : o.options.selectable) {
                        var s, a = e;
                        if (this.selectNodeHandler.isNodeSelected(a)) n.mustToggle && (this._deselectCurrentNode(), this._triggerEvent("tree.select", {
                            node: null,
                            previous_node: a
                        }));
                        else {
                            var l = this.getSelectedNode();
                            this._deselectCurrentNode(), this.addToSelection(a, n.mustSetFocus), this._triggerEvent("tree.select", {
                                node: a,
                                deselected_node: l
                ...
                e && (this._triggerEvent("tree.load_data", {
                    tree_data: e
                }), t ? (this._deselectNodes(t), this._loadSubtree(e, t)) : this._initTree(e), this.isDragging() && this.dndHandler && this.dndHandler.refresh())
        ...
        l = function() {
            ...
            return e.prototype.mouseCapture = function(e) {
                ...
                if (this.currentItem && void 0 !== e.pageX && void 0 !== e.pageY) {
                    ...
                    return this.dragElement = new u(s, e.pageX - o, e.pageY - n, this.treeWidget.element), this.isDragging = !0, this.positionInfo = e, this.currentItem.$element.addClass("jqtree-moving"), !0
                }
                return !1
    ...
    var u = function() {
        function e(e, t, o, n) {
            this.offsetX = t, this.offsetY = o, this.$element = i('<span class="jqtree-title jqtree-dragging">' + e + "</span>"), this.$element.css("position", "absolute"), n.append(this.$element)
        }
    ...
    var n = o(1),
        r = function() {
            ...
            return e.prototype.render = function(e) {
                ...
                var t, o;
                e ? (t = "jqtree-tree", o = "tree", this.treeWidget.options.rtl && (t += " jqtree-rtl")) : (t = "", o = "group");
                ...
                return i && (a += " jqtree-title-folder"), s.className = a, s.setAttribute("role", "treeitem"), s.setAttribute("aria-level", "" + t), s.setAttribute("aria-selected", n.getBoolString(o)), s.setAttribute("aria-expanded", n.getBoolString(r)), o && s.setAttribute("tabindex", this.treeWidget.options.tabIndex), s.innerHTML = this.escapeIfNecessary(e), s
    ...
    var n = function() {
        ...
        return e.prototype.deinit = function() {
            ...
            return !e || (this.treeWidget.selectNode(e), this.treeWidget.scrollHandler && !this.treeWidget.scrollHandler.isScrolledIntoView(jQuery(e.element).find(".jqtree-element")) && this.treeWidget.scrollToNode(e), !1)
    ...
    var i = function(e) {
        ...
        return r(t, e), t.prototype.setMouseDelay = function(e) {
            ...
            if (this.isMouseStarted && this._handleMouseUp(e), this.mouseDownInfo = e, this._mouseCapture(e)) return this._handleStartMouse(), !0
        }, t.prototype._handleStartMouse = function() {
            var e = jQuery(document);
            e.on("mousemove.mousewidget", this.mouseMove), e.on("touchmove.mousewidget", this.touchMove), e.on("mouseup.mousewidget", this.mouseUp), e.on("touchend.mousewidget", this.touchEnd), this.mouseDelay && this._startMouseDelayTimer()
            ...
            return this.isMouseStarted ? (this._mouseDrag(t), e.preventDefault()) : !(!this.mouseDelay || this.isMouseDelayMet) || (this.mouseDownInfo && (this.isMouseStarted = !1 !== this._mouseStart(this.mouseDownInfo)), this.isMouseStarted ? this._mouseDrag(t) : this._handleMouseUp(t), !this.isMouseStarted)
            ...
            t.off("mousemove.mousewidget"), t.off("touchmove.mousewidget"), t.off("mouseup.mousewidget"), t.off("touchend.mousewidget"), this.isMouseStarted && (this.isMouseStarted = !1, this._mouseStop(e))
        }, t
    }(o(3).default);
    t.default = i
}, function(e, t, o) {
            ...
            return e.prototype.saveState = function() {
                ...
                var n = this,
                    ...
                    s = function() {
                        ...
                        i = e, n._selectInitialNodes(t) && n.treeWidget._refreshElements(null), 0 === r && o()
                    },
                    a = function(e) {
