...
<?php $img=$res['img']!='' ? UPLOADS.$res['img'] :'/templates/myblog/images/pimage.jpg';?>
 
<a class="viewImage" href="<?=$img?>" title="">
 <img class="right edit-post-img" style="width: 100%;height: 130px;margin: 15px 0px 0 0;" src="<?=$img?>" alt="<?=$img?>"/>
 </a>
