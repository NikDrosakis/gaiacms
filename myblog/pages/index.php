<?php //updated:2020-01-29 20:20:37 index- v.0.73 - Author:Nikos Drosakis - License: GPL License ?>

<div id="topbar"><img id="bgimg" class="pvar">
    <div id="toptitle">
        <a href="/"><img id="logo" class="pvar" src="/gaia/img/logo.png"> </a>
        <h1 id="title" class="pvar"></h1>
        <h2  id="subtitle" class="pvar"></h2>
		
		<a download id="gaia_download" class="btn btn-success">Download Gaia latest version</a>
		<a download href="https://api.aimd5.com/repo/templates/myblog-0.1.tar.gz" class="btn btn-success">Download Myblog template</a>
		<script>
					var find={
		...
		var gaia_latest_version=parseFloat(res.docs[0]._id).toFixed(2)			
				//var html = 'Latest gaiaCMS version '+gaia_latest_version;
		$('#gaia_download').attr('href',"https://api.aimd5.com/repo/gaia/gaia-"+gaia_latest_version+".tar.gz");		
		},'POST');
		</script>
    </div>
</div>
    ...
    <div id="main">
        ...
        <div id="ele1" class="wid" style="font-size=16px"></div>
...
<footer>
    ...
    <div id="footcol4" class="footcolc widget wid">
