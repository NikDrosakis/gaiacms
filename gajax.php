<?php //updated:2020-02-11 13:00:20 gajax- v.0.73 - Author:Nikos Drosakis - License: GPL License ?>
<?php 
...
/*-------------------REGISTER---------------------------------*/
    ...
    $template_folder = $cms->TEMPLATES. $b;
            if($cms->template_new($b)){
               if (
                   file_put_contents($template_folder.'/pages/index.php', htmlspecialchars_decode($c)) &&
