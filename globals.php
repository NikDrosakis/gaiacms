...
foreach(glob(SITE_ROOT."templates/".$TEMPLATE."/pages/*.php") as $file){$pages[]=explode('.',basename($file))[0];};
//SETUP.JSON
//$CONF= config('',true);
$DOMAIN= HTTP_HOST;
//$DOMAINS= $CONF['doms'];
$PAGESURI=SITE_ROOT."templates/".$TEMPLATE."/pages/";
$PAGESPATH=SITE_URL."templates/".$TEMPLATE."/pages/";
...
'API_TEMPLATESURI' => '/var/www/api/store/templates/',
'API_TEMPLATESREPOPATH' => 'https://api.aimd5.com/repo/templates/',
'API_TEMPLATESPATH' => 'https://api.aimd5.com/store/templates/',
