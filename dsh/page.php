...
<?php define("BUILDEROOT","/gaia/lib/builder/");?>
...
$(document).ready(function() 
{
	...
	[
        ...
        ?>
        //{name:"<?php echo ucfirst($pathInfo['filename']);?>", title:"<?php echo ucfirst($pathInfo['filename']);?>",  url: "<?=SITE_URL.'/templates/'.$this->GS['template'].'/pages/'.$pathInfo['basename'];?>"},
